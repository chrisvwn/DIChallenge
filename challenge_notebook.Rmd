...
g
```
It seems that there is a relationship between higher levels of short sleep and higher nightlight radiances: they have a correlation of `cor(states$nlpersqkm, states$pctShortSleep)` although more work is needed to find out if it is significant.
